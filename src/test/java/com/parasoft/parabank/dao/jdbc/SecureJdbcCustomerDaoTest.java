...
/**
 * Parasoft Jtest UTA: Test class for SecureJdbcCustomerDao
 *
 * @see com.parasoft.parabank.dao.jdbc.SecureJdbcCustomerDao
 * @author devtest
 */
public class SecureJdbcCustomerDaoTest {

	/**
	 * Parasoft Jtest UTA: Test for updateCustomer(Customer)
	 *
	 * @see com.parasoft.parabank.dao.jdbc.SecureJdbcCustomerDao#updateCustomer(Customer)
	 * @author devtest
	 */
	@Test(timeout = 10000)
	public void testUpdateCustomer() throws Throwable {
		// Given
		SecureJdbcCustomerDao underTest = new SecureJdbcCustomerDao();
		...
		// Then - assertions for this instance of SecureJdbcCustomerDao
