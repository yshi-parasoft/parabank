...
/**
 * Parasoft Jtest UTA: Test class for SecureJdbcTransactionDao
 *
 * @see com.parasoft.parabank.dao.jdbc.SecureJdbcTransactionDao
 * @author devtest
 */
public class SecureJdbcTransactionDaoTest {

	/**
	 * Parasoft Jtest UTA: Test for getRestrictions(TransactionCriteria, List)
	 *
	 * @see com.parasoft.parabank.dao.jdbc.SecureJdbcTransactionDao#getRestrictions(TransactionCriteria, List)
	 * @author devtest
	 */
	@Test(timeout = 10000)
	public void testGetRestrictions() throws Throwable {
		// Given
		SecureJdbcTransactionDao underTest = new SecureJdbcTransactionDao();
		...
		// Then - assertions for this instance of SecureJdbcTransactionDao
	...
	private static TransactionCriteria mockTransactionCriteria() throws Throwable {
		...
		SearchType getSearchTypeResult2 = SearchType.ACTIVITY; // UTA: default value
		when(criteria.getSearchType()).thenReturn(getSearchTypeResult, getSearchTypeResult2);
		return criteria;
	}
