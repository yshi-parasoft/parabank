...
/**
 * Parasoft Jtest UTA: Test class for JmsListenerController
 *
 * @see com.parasoft.parabank.web.controller.JmsListenerController
 * @author devtest
 */
public class JmsListenerControllerTest {
	 ...
	 *
	 * @see com.parasoft.parabank.web.controller.JmsListenerController#destroy()
	 * @author devtest
	 */
	@Test(timeout = 10000)
	public void testDestroy() throws Throwable {
		// Given
		JmsListenerController underTest = new JmsListenerController();
		...
		// Then - assertions for this instance of JmsListenerController
	 ...
	 *
	 * @see com.parasoft.parabank.web.controller.JmsListenerController#getForm()
	 * @author devtest
	 */
	@Test(timeout = 10000)
	 ...
	 *
	 * @see com.parasoft.parabank.web.controller.JmsListenerController#handleRequest(String, Model)
	 * @author devtest
	 */
	@Test(timeout = 10000)
	public void testHandleRequest() throws Throwable {
		...
		// When
		String sShutdown = "sShutdown"; // UTA: default value
		Model model = mockModel();
		ModelAndView result = underTest.handleRequest(sShutdown, model);
	 ...
	 */
	@Test(timeout = 10000)
	public void testSaveAdminSettings2() throws Throwable {
		// Given
		JmsListenerController underTest = new JmsListenerController();
		AdminManager adminManager = mock(AdminManager.class);
		underTest.setAdminManager(adminManager);
