...
/**
 * Parasoft Jtest UTA: Test class for SecureCartService
 *
 * @see com.parasoft.bookstore.SecureCartService
 * @author devtest
 */
public class SecureCartServiceTest {

	/**
	 * Parasoft Jtest UTA: Test for getItemByTitle(String)
	 *
	 * @see com.parasoft.bookstore.SecureCartService#getItemByTitle(String)
	 * @author devtest
	 */
	@Test(timeout = 10000)
	public void testGetItemByTitle() throws Throwable {
		// Given
		SecureCartService underTest = new SecureCartService();
