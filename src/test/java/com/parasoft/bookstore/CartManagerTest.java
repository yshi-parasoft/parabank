...
public class CartManagerTest {
	 ...
	 *
	 * @see com.parasoft.bookstore.CartManager#addExistingItemToCart(int, Order)
	 * @author devtest
	 */
	@Test(timeout = 10000)
	 ...
	 *
	 * @see com.parasoft.bookstore.CartManager#getCartSize(int)
	 * @author devtest
	 */
	@Test(timeout = 10000)
	 ...
	 *
	 * @see com.parasoft.bookstore.CartManager#setItem(List)
	 * @author devtest
	 */
	@Test(timeout = 10000)
	 ...
	 */
	@Test(timeout = 10000, expected = Exception.class)
	public void testUpdateExistingItem4() throws Throwable {
		// Given
		CartManager underTest = new CartManager();

		// When
		int cartId = 0; // UTA: default value
		int itemId = -999; // UTA: provided value
		int quantity = -999; // UTA: provided value
		underTest.updateExistingItem(cartId, itemId, quantity);
